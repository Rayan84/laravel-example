          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <!-- Profile dropdown -->
             <div class="relative ml-3">
              <div>
                <button type="button" class="relative flex max-w-x5 items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring">
                  <span class="absolute -inset-1.5"></span>
